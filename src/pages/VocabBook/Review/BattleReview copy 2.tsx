...
export default function BattleReviewCopy() {
  ...
  const answerCountAfterClick = { ...answerCount };
  ...
  useEffect(() => {
    ...
    if (countDown === 0 && round + 1 < questionsNumber) {
      // handleSyncScore();
      setAnswerCount(answerCountAfterClick);
      // handleSyncIsCorrect(addIsCorrectInQuestions);
      setTimeout(() => {
            ...
            <Option
              ...
              onClick={() => {
                if (!isAnswered) {
                  ...
                  handleSyncScore();
                  // setReviewingQuestions(addIsCorrectInQuestions);
                  handleSyncIsCorrect(addIsCorrectInQuestions);
                }
              }}
            >
